...
@auth_router.post("/login", summary="Create access and refresh token for users", response_model=TokenSchema)
...
@auth_router.post('/refresh', summary="Refresh access token using refresh token", response_model=TokenSchema)
